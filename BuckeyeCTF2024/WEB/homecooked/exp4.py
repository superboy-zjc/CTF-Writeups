...
base_url = "https://homecooked.challs.pwnoh.io"
...
def fuzz_index(fuzz_value):
    ...
    try:
        # Send the fuzzing POST request using the json= argument
...
def main():
    ...
    num_threads = 50  # You can adjust this value based on your system's resources
